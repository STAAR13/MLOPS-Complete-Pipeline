...
def main():
    try:
        ...
        params = load_params(params_path=str(params_path))
        ...
        save_data(train_df, str(root_dir / 'data' / 'processed' / 'train_tfidf.csv'))
        save_data(test_df, str(root_dir / 'data' / 'processed' / 'test_tfidf.csv'))
    except Exception as e:
